...
mod tests {
    ...
    fn scenario(rec_b: ImageRecord, rec_d: ImageRecord, rec_e: ImageRecord) -> Vec<ImageMessage> {
    ...
    #[tokio::test]
    async fn save_stage_records_message_counts_as_metrics() {
