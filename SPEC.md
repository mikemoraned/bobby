...
Find selfies people take of themselves with landmarks.
...
1. Listen to the Bluesky firehose
2. Apply hard-constraint filtering steps i.e. every image should have this:
    ...
    * the image:
        ...
        * should contain a landmark of some kind
...
3. Dump candidates into a folder:
